...
const ReadSoilDetail: React.FC<Props> = ({ navigation, route }) => {
  ...
  const getSensorStatus = (sensorType: string) => {
    ...
    switch (sensorType.toLowerCase()) {
      case 'ph':
        if (numValue < 6.0) return { status: 'Low', color: 'red', icon: 'arrow-down' };
        if (numValue > 7.5) return { status: 'High', color: 'orange', icon: 'arrow-up' };
        return { status: 'Good', color: 'green', icon: 'arrow-up' };
      
      case 'ec':
        if (numValue < 400) return { status: 'Low', color: 'red', icon: 'arrow-down' };
        if (numValue > 800) return { status: 'High', color: 'orange', icon: 'arrow-up' };
        return { status: 'Good', color: 'green', icon: 'arrow-up' };
      
      case 'nitrogen':
        if (numValue < 50) return { status: 'Low', color: 'red', icon: 'arrow-down' };
        if (numValue > 150) return { status: 'High', color: 'orange', icon: 'arrow-up' };
        return { status: 'Good', color: 'green', icon: 'arrow-up' };
      
      case 'phosphorus':
        if (numValue < 100) return { status: 'Low', color: 'red', icon: 'arrow-down' };
        if (numValue > 300) return { status: 'High', color: 'orange', icon: 'arrow-up' };
        return { status: 'Good', color: 'green', icon: 'arrow-up' };
          ...
          <View style={styles.soilStatisticTwo}>
            <View style={styles.detailStatisticOne}>
              <View style={styles.statContent}>
                ...
                <Text style={styles.statValue}>{nitrogenValue} mg/L</Text>
              </View>
              <View style={styles.statExtra}>
            ...
            <View style={styles.detailStatisticOne}>
              <View style={styles.statContent}>
                ...
                <Text style={styles.statValue}>{phosphorusValue} mg/L</Text>
              </View>
              <View style={styles.statExtra}>
          ...
          <View style={styles.soilStatisticTwo}>
            <View style={styles.detailStatisticOneKal}>
              <View style={styles.statContent}>
                ...
                <Text style={styles.statValue}>{kaliumValue} mg/L</Text>
              </View>
              <View style={styles.statExtra}>
